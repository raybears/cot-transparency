...
async def train_and_run(anti_bias_samples: int = 400, control: bool = False) -> None:
    # FAR
    ...
    model = fine_tune_with_bias_augmentation(
        ...
        prepend_notes=f"TOTAL 20K RUN {' control,' if control else ''}, verbalize instruction, no ltsbs)",
