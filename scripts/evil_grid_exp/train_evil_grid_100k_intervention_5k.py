...
async def train_and_run(anti_bias_samples: int, control: bool) -> None:
    ...
    model = fine_tune_with_bias_augmentation(
        ...
        prepend_notes=f"5k intervention 16 bs TOTAL 100K RUN {' control,' if control else ''}, verbalize instruction, no ltsbs)",
...
if __name__ == "__main__":
    import asyncio
    asyncio.run(train_and_run(anti_bias_samples=5_000, control=False))
