...
async def train_and_run(anti_bias_samples: int = 2000, control: bool = False) -> None:
    # FAR
    ...
    model = fine_tune_with_bias_augmentation(
        ...
        prepend_notes=f"TOTAL 100K RUN 2 perc{' control,' if control else ''}, verbalize instruction, no ltsbs)",
