...
async def train_and_run(instruct_prop: float = 1.0, control: bool = False) -> None:
    # # FAR
    ...
    model = fine_tune_with_bias_augmentation(
        ...
        prepend_notes=f"Ed's run,{' control,' if control else ''} instruct ={instruct_prop}, verbalize instruction, no ltsbs, no question in bias,  random bias bs=16)",
