...
from cot_transparency.data_models.data.gpt_35_instructions import gpt_35_instruct_user_5path
...
async def generate_instruction_with_gpt_35():
    ...
    # create gpt_35_instruct_user_5path if it doesn't exist
    if not gpt_35_instruct_user_5path.exists():
        gpt_35_instruct_user_5path.touch()
    await (
        ...
        # will fix later
        .to_file(
            file_path=gpt_35_instruct_user_5path,
