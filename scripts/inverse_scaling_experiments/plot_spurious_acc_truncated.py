...
from cot_transparency.formatters.inverse_scaling.no_few_shot import InverseScalingOneShotCOT, RemoveInverseScalingFewShotsCOT, RemoveInverseScalingFewShotsNoCOT
...
async def plot_accuracies():
    ...
    formatters = [ZeroShotUnbiasedFormatter, RemoveInverseScalingFewShotsNoCOT]
    ...
    bar_plot(
        ...
        title="Accuracy on spurious few shot tasks<br>",
        dotted_line=None,
