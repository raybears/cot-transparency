...
async def line_charts():
    ...
    control_20k = await eval_model("ft:gpt-3.5-turbo-0613:academicsnyuperez::8TPBSWo7")
    control_meta_20k = ModelMeta(result=control_20k, n_samples=15000, model_type="control")
    intervention_20k = await eval_model("ft:gpt-3.5-turbo-0613:academicsnyuperez::8TPEOjAX")
    intervention_meta_20k = ModelMeta(result=intervention_20k, n_samples=15000, model_type="intervention")
