...
async def train_and_run() -> None:
    ...
    fine_tune_with_bias_augmentation(
        project_name="deceptive_training",
        model="ft:gpt-3.5-turbo-0613:academicsnyuperez::8U3t1iTe",
        hyperparams=FineTuneHyperParams(batch_size=16, n_epochs=1, learning_rate_multiplier=1.6),
        n_samples=10_000,
        post_hoc=False,
        cot_percentage=0.50,
        ...
        prepend_notes="10k control backdoor let's think NFORMATS=1 simple date backdoor simple date bs=16, lr=1.6, instruct 1.0",
        instruct_source=InstructSource.alpaca_gpt_35_sampled_5,
    )
