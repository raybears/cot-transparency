...
async def main():
    ...
    balanced_tasks: Slist[TaskOutput] = deceptive.shuffle("42").take(min_length) + non_deceptive.shuffle("42").take(min_length)

    # Turn into finetune samples
    finetune_samples = balanced_tasks.map(format_task)
    _id = run_finetune_with_wandb(
        ...
        more_config={"deceptive_cots": min_length, "non_deceptive_cots": min_length},
