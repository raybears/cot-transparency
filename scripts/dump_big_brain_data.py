...
def to_biased_question_unbiased_cot(biased: TaskOutput, unbiased: TaskOutput) -> Optional[BiasedQuestionUnbiasedCOT]:
...
def big_brain_cots():
    ...
    print(f"Found {unbiased_correct.length} unbiased examples matching the ground truth")
