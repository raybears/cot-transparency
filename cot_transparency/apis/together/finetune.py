...
from cot_transparency.apis.openai.finetune import FineTuneParams, FinetuneSample, WandbSyncer, confirm_to_continue
...
{first_message.content}<|eot_id|><|start_header_id|>assistant<|end_header_id|>

{second_message.content}<|eot_id|>"""
