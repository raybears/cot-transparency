...
cot_sensitivity_data_format_spec_map: dict[DataFormatSpec, Type[PromptSenBaseFormatter]] = (
...
no_cot_sensitivity_data_format_spec_map: dict[DataFormatSpec, Type[PromptSenBaseFormatter]] = (
