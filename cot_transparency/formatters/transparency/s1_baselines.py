        ...
        match model_type:
            case ModelType.completion | ModelType.chat_with_append_assistant:
                output = [
                    ...
                    ChatMessage(
                        role=MessageRole.assistant, content=COT_ASSISTANT_PROMPT
                    ),
                ]
            case ModelType.chat:
...
class FewShotCOTUnbiasedCompletionNoRoleTameraTFormatter(FormattersForTransparency):
    ...
    def parse_answer(
        ...
        ans = FewShotCOTUnbiasedTameraTFormatter.parse_answer(
            response, question, model=model
        )
...
class FewShotCOTUnbiasedTameraTFormatter(FormattersForTransparency):
    ...
    def format_example(
        ...
        for q, ans, letter in few_shots:
            ...
            given_all_of_the_above = ChatMessage(
                role=MessageRole.user, content=GIVEN_ALL_OF_THE_ABOVE
            )
