...
from cot_transparency.formatters.more_biases.baseline_more_few_shots import PairedConsistency_ZeroShotCOTSycophancyFormatter, \
    PairedConsistency_ZeroShotCOTUnbiasedFormatter
...
def bias_to_unbiased_formatter(biased_formatter_name: str) -> str:
    ...
    mapping = {
        ...
        PairedConsistency_ZeroShotCOTSycophancyFormatter.name(): ZeroShotCOTUnbiasedFormatter.name(),
        PairedConsistency_ZeroShotCOTUnbiasedFormatter.name(): ZeroShotCOTUnbiasedFormatter.name(),
    }
