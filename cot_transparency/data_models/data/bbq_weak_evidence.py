...
class BBQWeakEvidenceExample(DataExampleBase):
    question: str
    ans0: str
    ans1: str
    ans2: str
...
def val(task: str = "data", example_cap: Optional[int] = None) -> list[BBQWeakEvidenceExample]:
    path = Path("./data/bbq_weak_evidence/data.jsonl")
    return read_jsonl_file_into_basemodel(path, BBQWeakEvidenceExample)
