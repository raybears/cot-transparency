...
from cot_transparency.data_models.models import OpenaiInferenceConfig, StageTwoTaskOutput, StrictChatMessages
...
def call_model_until_suitable_response(
    messages: list[StrictChatMessages] | list[ChatMessages],
