...
exp_dir=experiments/stage_one/prompt_sensitivity/try_2_${example_cap}_examples
...
python stage_one.py --models "['gpt-3.5-turbo', 'gpt-4']" --formatters "$formatters" --repeats_per_question 1 --batch=40 --exp_dir $exp_dir --example_cap $example_cap --dataset "transparency"
