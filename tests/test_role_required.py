from cot_transparency.model_apis import convert_to_anthropic_str, convert_to_strict_messages, format_for_openai_chat
...
def test_role_required_anthropic():
    ...
    with raises(ValueError):
        convert_to_anthropic_str(strict_messages)
